...
if __name__ == "__main__":
    csv_file = "data\HR Employee Attrition.csv"  # Replace with your CSV file name
    db_file = "HR_Employee_Attrition.db"        # Replace with your desired output database file name
    table_name = "HR_Employee_Attrition"                 # Replace with your desired table name
